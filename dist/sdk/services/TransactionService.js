  ...
  return _createClass(TransactionService, [{
    ...
    function signSerializedTransaction(serializedTransaction, signer) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var transactionBuffer, transaction, signedTransaction;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              throw new Error("Failed to sign transaction: ".concat(_context.t0 instanceof Error ? _context.t0.message : String(_context.t0)));
            case 12:
            case "end":
    ...
    key: "sendTransaction",
    value: function sendTransaction(signedTransaction, connection, options) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              throw new Error("Failed to send transaction: ".concat(_context2.t0 instanceof Error ? _context2.t0.message : String(_context2.t0)));
            case 10:
            case "end":
    ...
    value: function signAndSendTransaction(serializedTransaction, signer, options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var connection, signedTransaction;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              connection = new web3_js_1.Connection(constants_1.RPC_URL);
              _context3.next = 3;
              return this.signSerializedTransaction(serializedTransaction, signer);
            case 3:
              signedTransaction = _context3.sent;
              return _context3.abrupt("return", this.sendTransaction(signedTransaction, connection, options));
            case 5:
            case "end":
...
var Transaction_Service = new TransactionService();
exports["default"] = Transaction_Service;